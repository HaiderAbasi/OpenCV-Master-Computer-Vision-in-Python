...
if __name__ == '__main__':
    ...
    # input and output
    parser.add_argument('--input_path', type=str, default=r'input/room.mp4', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--classes', nargs='+', type=int, default=[], help='filter by class')
