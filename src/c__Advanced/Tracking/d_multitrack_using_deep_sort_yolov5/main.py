...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default=r'Data\NonFree\Advanced\Tracking\DeepSort\surveillance.webm', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--save_path', type=str, default="", help='output folder')  # output folder
    parser.add_argument("--frame_interval", type=int, default=2)
    parser.add_argument('--fourcc', type=str, default='mp4v', help='output video codec (verify ffmpeg support)')
    parser.add_argument('--device', default='', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--save_txt', default='src/c__Advanced/Tracking\DeepSORT_YOLOv5/output/predict/', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    ...
    # YOLO-V5 parameters
    parser.add_argument('--weights', type=str, default='src/c__Advanced/Tracking\DeepSORT_YOLOv5/yolov5/weights/yolov5m.pt', help='model.pt path')
    ...
    # deepsort parameters
    parser.add_argument("--config_deepsort", type=str, default=r"src/c__Advanced/Tracking\DeepSORT_YOLOv5/configs/deep_sort.yaml")
