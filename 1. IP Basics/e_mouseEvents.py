...
from utilities import imshow,get_optimal_font_scale
import glob
import os
...
def main():
    ...
    while(1):
        ...
        img = cv2.resize(img,windowSize) # Resizing every image to default windowSize (480,360)
